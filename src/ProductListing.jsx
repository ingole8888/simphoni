  ...
  return (
    <>
      ...
      {loading1 ? (
        ...
        <div className="p-4">
          <h1 className="text-l font-bold mb-2">Your search result</h1>
                  ...
                  <div
                    ...
                    <div className="border p-4 flex flex-col justify-between">
                      <div className="flex-none h-1/3 mb-2">
                        <img src="https://images.pexels.com/photos/4041392/pexels-photo-4041392.jpeg?cs=srgb&dl=pexels-karolina-grabowska-4041392.jpg&fm=jpg" alt='' className="w-full h-full object-cover" />
                      </div>
                      <div>
      ...
      {loading ? (
        ...
        <div className="p-4">
          <h1 className="text-l font-bold mb-2">All products</h1>
